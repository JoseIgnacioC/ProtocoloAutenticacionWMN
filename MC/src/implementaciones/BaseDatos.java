...
public class BaseDatos {
    ...
    public void actualizarRegistroClientes(ArrayList<String> clientes){
        
        FileWriter fichero = null;
        PrintWriter pw = null;
        try{
            fichero = new FileWriter(nodo+"Clientes.txt");
            pw = new PrintWriter(fichero);
    ...
    public String[] obtenerDatosCliente(String identificador){
        ...
        try{
            archivo = new File(nodo+"Clientes.txt");
            fr = new FileReader(archivo);
            br = new BufferedReader(fr);
            ...
            while((linea = br.readLine())!=null ){                
                ...
                if(datos.length == 3){
                    ...
                    System.err.println("Error en la cantidad de datos en el registro de cada cliente");
            }  
        }catch(Exception e){
            e.printStackTrace();
        }finally{        
