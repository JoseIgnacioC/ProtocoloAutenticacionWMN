...
import implementaciones.InterfazMRImp;
...
public class Mensaje {
        ...
        switch (paso){
            ...
            case "9A":
                if(datos.length==4){
                    ...
                    this.identificadorSolicitante=datos[4];
                    this.timestamp=datos[5];
                    this.msjeEncriptadoPart=datos[6];
                    this.valorHash=datos[7];
                }
                else
                    System.err.println("Erroe en paso 9A");
                break;
    ...
    public String crearStrPaso10A12B(CBI cbi, PublicKey llavePublica) throws Exception{
        ...
        String txtPlano = identificadorProtocolo+","+identificadorEmisor+","+identificadorReceptor;
        String txtCifrado = nonceFreshRespuesta+","+nonceLiveRespuesta+","+valorZpVerificador+","+prueba+","+valorHMac+","+valorHash;
